    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="inline-block px-3 py-1 rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 text-sm font-medium">
        ...
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-slate-800 dark:text-slate-200">Description</h4>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-semibold text-slate-800 dark:text-slate-200">Time Complexity</h4>
            </div>
          ...
          <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-semibold text-slate-800 dark:text-slate-200">Space Complexity</h4>
            </div>
            <p className="text-slate-600 dark:text-slate-400 font-mono">
